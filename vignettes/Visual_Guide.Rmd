...
p6
p6$transform(1:5)
ggplot(mtcars) + geom_point(aes(mpg, cyl)) + scale_y_continuous(trans = p6)
```
...
```{r, echo=TRUE, eval=TRUE, fig.align='center'}
p6r <- trans_reverser(p6)
p6r
ggplot(mtcars) + geom_point(aes(mpg, cyl)) + scale_y_continuous(trans = p6r)
```
